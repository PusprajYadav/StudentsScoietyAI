import{b1 as te,b2 as se,b3 as re,j as e,bt as ne,aT as ae,L as ie,bA as oe,y as ce,bL as X,aM as de,r as c,z as y}from"./ui-4r3tghOU.js";import{F as le,f as pe,e as ue,a as me}from"./index-DEozk6jd.js";const F="student-society-code-studio-v4",Y="student-society-code-studio-preview",k="Run your code to see stdout, compile output, and runtime messages here.",C="Run the preview to see console logs, render status, and browser errors here.",xe="#e7efff",Q=["javascript","typescript","python","java","cpp","csharp","c","ruby","php","go","rust"],he=[...Q,"html","css","web"],z=[{key:"mobile",label:"Mobile",description:"390px width",icon:te},{key:"tablet",label:"Tablet",description:"768px width",icon:se},{key:"laptop",label:"Laptop",description:"Full workspace width",icon:re}],w={javascript:"JavaScript",typescript:"TypeScript",python:"Python",java:"Java",cpp:"C++",csharp:"C#",c:"C",ruby:"Ruby",php:"PHP",go:"Go",rust:"Rust",html:"HTML",css:"CSS",web:"Web (HTML + CSS + JS)"},T={javascript:`function greet(name) {
  return \`Hello, \${name}!\`;
}
