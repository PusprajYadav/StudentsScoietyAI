...
export function PortfolioShareSheet({
  shareState,
  setShareState,
  joinedCommunities,
  ...
  shareState: PortfolioShareState;
  setShareState: Dispatch<SetStateAction<PortfolioShareState>>;
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-950/40 p-3 sm:items-center sm:p-6">
      <div className="surface-card max-h-[88vh] w-full max-w-2xl overflow-y-auto rounded-[28px] p-4 sm:p-5">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-app-muted">Share portfolio</p>
            ...
            <p className="mt-1 text-[11px] leading-5 text-app-muted sm:text-xs">
              Publish your live portfolio to the feed to showcase your projects and skills. Your post will embed the public URL.
            </p>
          </div>
        ...
        <label className="mt-3 grid gap-1 text-[11px] font-medium text-app-muted">
          ...
          <input
            ...
            className="input-field"
            placeholder="Check out my updated portfolio!"
        ...
        <label className="mt-3 grid gap-1 text-[11px] font-medium text-app-muted">
          ...
          <textarea
            ...
            placeholder="I just finished creating this portfolio to highlight my newest projects..."
            disabled={shareState.submitting}
          />
        </label>
        ...
        <div className="mt-3 rounded-[20px] border border-app-border bg-app-card p-3">
          <div className="mb-2 flex items-center gap-2 text-app-text">
            ...
            <p className="font-medium text-xs sm:text-sm">Live portfolio embed attachment</p>
          </div>
          <p className="text-[11px] leading-5 text-app-muted">
            Your public portfolio URL will be embedded in the post: <strong>{shareSnapshotFallback}</strong><br/>
            Any future updates to your portfolio will automatically reflect in the post preview.
          </p>
        </div>
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-2">
          <p className="text-[11px] text-app-muted">
            {shareState.loading
              ...
              : "Ensure your portfolio content is exactly what you intend to share publicly."}
          </p>
          <button
            type="button"
            onClick={onSubmit}
